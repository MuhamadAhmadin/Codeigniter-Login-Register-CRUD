                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a href="<?= base_url('/dashboard/loker/new'); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="<?= base_url('dashboard/loker/'.$item->id.'/edit') ?>"
                                                    class="btn btn-sm btn-outline-warning mr-1">Edit</a>
                                                <a href="#"
                                                    data-href="<?= base_url('dashboard/loker/'.$item->id.'/delete') ?>"
