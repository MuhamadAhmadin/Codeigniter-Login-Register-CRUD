            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('dashboard/freelancer/'. $data->id .'/update') ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control">
                                        ...
                                        <?php foreach($companies as $item): ?>
                                            <option value="<?= $item->id ?>" <?= $data->company_id == $item->id ? 'selected' : ''; ?>><?= $item->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="skill_id" id="skill_id" class="form-control">
                                        ...
                                        <?php foreach($skills as $item): ?>
                                            <option value="<?= $item->id ?>" <?= $data->skill_id == $item->id ? 'selected' : ''; ?>><?= $item->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
