                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a href="<?= base_url('/dashboard/freelancer/new'); ?>" class="btn btn-sm btn-primary"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach($freelancers as $item): ?>
                                        <tr>
                                            <td><?= $item->id ?></td>
                                            <td><?= $item->nik ?></td>
                                            <td><?= $item->nama ?></td>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="<?= base_url('dashboard/freelancer/'.$item->id.'/edit') ?>"
                                                    class="btn btn-sm btn-outline-warning mr-1">Edit</a>
                                                <a href="#"
                                                    data-href="<?= base_url('dashboard/freelancer/'.$item->id.'/delete') ?>"
